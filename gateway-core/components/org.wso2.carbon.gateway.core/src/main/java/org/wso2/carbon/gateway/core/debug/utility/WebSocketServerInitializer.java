...
public class WebSocketServerInitializer extends ChannelInitializer<SocketChannel> {
    ...
    public WebSocketServerInitializer(SslContext sslCtx, GatewayDebugManager gatewayDebugManager,
                                      Semaphore runtimeSuspensionSem) {
        this.sslCtx = sslCtx;
    ...
    public void initChannel(SocketChannel ch) throws Exception {
        ...
        pipeline.addLast(new WebSocketFrameHandler(gatewayDebugManager, runtimeSuspensionSem));
    }
}
